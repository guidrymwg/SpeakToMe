# SpeakToMe
An Android project that illustrates some of the text to speech capabilities of the Android API.
...
http://eagle.phys.utk.edu/guidry/android/ and selecting <em>Speak To Me</em> from the menu.
